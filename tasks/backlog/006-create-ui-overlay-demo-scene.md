...
- Prefer not to alter `scripts/main.gd` UI behavior. If minimal wiring into a central file is reasonably necessary for the demo scene to function, make the smallest useful change, checkpoint it, validate, and report why it was needed.
